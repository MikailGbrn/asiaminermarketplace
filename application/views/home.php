...
<html lang="en">
  <head>
    <?php $this->load->view('template/header_scripts') ?>
  </head>
  <body>
  
  <div class="site-wrap">

    <?php $this->load->view('template/nav_bar') ?>

    <div class="site-blocks-cover overlay" style="background-image: url(<?php echo base_url() ?>assets/frontend/images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
