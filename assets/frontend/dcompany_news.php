...
<body>
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar site-navbar-nothome position-fixed" role="banner">
      ...
      <div class="warp-container pr-4">
        <div class="row align-items-center">

          <div class="col-11 col-xl-2">

          </div>
          <div class="col-12 col-md-8 d-none d-xl-block text-center">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">Browse</a></h1>
          </div>
  ...
  <div class="site-section bg-light">
          ...
          <div class="company-profile">
            ...
            <div class="profile-content">
              ...
              <p>
                ...
                <span class="text-secondary"><span class="icon-clock-o mr-2"></span>10am until 10pm</span>
              </p>
              <p>
                <span class="mr-5 text-secondary"><span class="icon-envelope mr-2"></span>example@mail.com</span>
    ...
    <div class="container company-content">
      ...
      <div class="row mb-3">
        <div class="col-md-12">
          <h4 class="contentsection">News (3)</h4>
        </div>
        <div class="col-md-12">
          ...
          <div class="h-entry h-option">
            <a href="#">
              ...
              <div class="h-entry-inner">
                <h2 class="font-size-regular"><object><a href="blog-single.html">News Title</a></object></h2>
                <p class="text-secondary"><object>September, 20 2020</object></p>
      ...
      <div class="modal-body">
        <form action="#">
          <div class="row">             
            ...
            <div class="form-group col-md-12 mt-3 mb-md-0">
              <label class="text-secondary" for="#title">Product Name</label>
              <input type="text" id="title" class="form-control" placeholder="your product name">
            </div>
            <div class="form-group col-md-12 mt-3 mb-md-0">
...
<div id="uploadheaderimageModal" class="modal fade" role="dialog">
 <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
  <div class="modal-content">
    <div class="modal-header" >
      <h4 class="modal-title">Upload &amp; Crop Image</h4>
