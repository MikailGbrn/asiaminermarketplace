        ...
        <div class="row mt-5">
          ...
          <div class="col-md-10 mb-5">
            ...
            <form action="" method="post" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black" for="email">PIC Phone Number</label> 
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <select name="pic_phone_code" class="selectpicker form-control" data-live-search="true" required="">
                    ...
                    <input type="tel" id="pnumber" class="form-control" value="{{ old('pic_phone') }}" name="pic_phone" required="">
                  </div>
                </div>
              </div>
