                ...
                <form action="{{ url('/company-profile/news')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="author" id="author" class="form-control" value="{{$news->author}}" placeholder="Add Author">
                    </div>
                  </div>
                  <div class="form-row">
                      <div class="form-group col-md-12">
                        ...
                        <select name="catagory[]" class="selectpicker form-control" data-live-search="true" multiple>
                          ...
                          <option value="{{$c->id}}" @if(in_array($c->id, $news->catagory->pluck('id')->toArray())) selected @endif>{{$c->name}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
