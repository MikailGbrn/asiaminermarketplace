...
@section('content')
  <div class="section">
    <div class="row">
      <div class="col s12">
        <div class="card" style="border-top: 5px solid #34495e ; border-radius:5px">
          <div class="card-content" style="padding-top: 10px; padding-bottom: 0px">
            <div class="fontt judul">
              <div style="letter-spacing: 1px">List Product</div>
            </div>
            ...
            <table id="data-table-simple" class="striped" cellspacing="0" style="">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-small green" target="_blank" style="margin-left: 10px" href="{{url("/product/$c->company_id/$c->slug")}}"><i class="material-icons">language</i></a>
                </td>
              </tr>
              @endforeach
              </tbody> 
